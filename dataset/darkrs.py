...
class DarkRS(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        gt_frames_path = os.path.join(self.cfg.root_gt, video_name, self.cfg.pos, self.cfg.img_type, "{}")
        input_frames_path = os.path.join(self.cfg.root_gt, video_name, "RS", self.cfg.img_type, "{}")
